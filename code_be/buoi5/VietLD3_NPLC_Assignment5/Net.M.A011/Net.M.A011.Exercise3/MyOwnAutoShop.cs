...
namespace Net.M.A011.Exercise3
{
    internal class MyOwnAutoShop
    {
        ...
        {
            Car sedan = new Sedan(2, 1, 5, "red"); // truyền dữ liệu  vào Sedan
            Console.WriteLine(sedan.ToString()); // in ra

            Car ford = new Ford(3, 1, 5, 2, "red"); // truyền dữ liệu  vào Ford
            Console.WriteLine(ford.ToString()); // in ra

            Car truck = new Truck(4, 2, 3, "red"); // truyền dữ liệu  vào Truck

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 4, 5, 14, 3, 59, 40, DateTimeKind.Local).AddTicks(8051)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "PostContent1", new DateTime(2023, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "ShortDescription1", "Title1", "one-to-many-conventions-entity-framework-core" });

            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "CategoryId", "Modified", "PostContent", "PostedOn", "Published", "ShortDescription", "Title", "UrlSlug" },
                values: new object[] { 2, 2, new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "PostContent2", new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "ShortDescription2", "Title2", "table-dataannotations-attribute-in-code-first" });

            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "CategoryId", "Modified", "PostContent", "PostedOn", "ShortDescription", "Title", "UrlSlug" },
                values: new object[] { 3, 3, new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "PostContent3", new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "ShortDescription3", "Title3", "demoo-abc" });

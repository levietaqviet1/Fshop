    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var avatar2 = info.Principal.FindFirstValue("picture") ?? "";
                // Tài khoản chưa có, tạo tài khoản mới
                var user = new UsingIdentityUser { UserName = Input.Email, Email = Input.Email, Firstname = info.Principal.FindFirstValue(ClaimTypes.Name), LastName = lastName };

...
namespace FA.JustBlog.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, RoleUnit.Role_User);
        ...
        private UsingIdentityUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(UsingIdentityUser)}'. " +
                    $"Ensure that '{nameof(UsingIdentityUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
        ...
        private IUserEmailStore<UsingIdentityUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<UsingIdentityUser>)_userStore;
        }
    }
}
